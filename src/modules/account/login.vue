  ...
  <div class="LoginContainer col-sm-12">
    <div class="row RowContainer">
      <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 col-xs-7 QouteCardContainer mb-5">
        <div class="QouteCard">
          <img :src="require('src/assets/img/logo.png')" alt="Image" id="image">
      ...
      <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 col-xs-5 d-flex justify-content-center LoginCardContainer mb-5">
        <div class="card LoginCard">
          <div class="card-body LoginCardBody">
            ...
            <div class="d-flex justify-content-between" id="buttons" style="">
            ...
            <div class="d-flex justify-content-center orSeparatorB">
              <p style="color: #CBAB58; margin-top: 30px;">Don't have an account?</p>
            </div>
            <hr>
            <div class="col-sm-12 col-md-12 col-lg-12 d-flex justify-content-end" style="margin-left: 4%; margin-top: 20px;">
              <roundedBtn 
                :onClick="register"
                :text="'Register Now'"
                :styles="{
