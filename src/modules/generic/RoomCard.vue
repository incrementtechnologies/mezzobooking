        ...
        <div class="card-horizontal">
          ...
          <div class="card-body">
            <div class="mb-4">
              ...
              <span style="float:right"><b>{{list.currency != null ? list.currency : 'PHP'}}{{list.regular != null ? list.regular : 0}}/{{list.label != null ? list.label : 'No Label'}}</b><i @click="$router.push('/add-rooms/'+ list.id)" class="fas fa-pencil ml-2"></i></span>
            </div>
